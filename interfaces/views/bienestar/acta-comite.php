            ...
            <div class="row">
                    ...
                    <div class="col-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="area"  value="Comité de Evaluación y Seguimiento" required readonly>                                  
                        </div>
                    </div>
                    <!-- Área -->
                    <div class="col-6">
            ...
            <div class="row">
                ...
                <div class="col-12">
                    <div class="form-group">
                        ...
                        <textarea  class="form-control style-textareaficha" name="ObjetivosReunion" id="objetivos" cols="20" rows="">Analizar los informes académicos y disciplinarios de los aprendices que fueron citados al Comité, y realizar las recomendaciones al Subdirector.</textarea>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-6">
                    <div class="form-group">
                        ...
                        <textarea  class="form-control style-textareaficha-bienestar" name="Temas-a-Tratar" id="temasTratar" cols="100" rows="">a. Presentación de Asistentes al Comité.
...
c. Exposición de informes y descargos de cada uno de los aprendices del área GESTIÓN Y DESARROLLO EMRESARIAL
d. Proposiciones y varios.
                ...
                <div class="col-6">
                    <div class="form-group">
                        ...
                        <textarea  class="form-control style-textareaficha-bienestar" name="Desarrollo" id="desarollo" cols="20" rows="" >a. Se realizó presentación por cada uno de los asistentes al Comité de Evaluación y seguimiento, conformado por:
...
b. Se verifica si hay quórum, para el desarrollo del Comité, ajustándonos al Reglamento del Aprendiz SENA, punto que queda aprobado.
c. Se da informe de los aprendices citados a Comité de Evaluación.
  ...
  <div class="card">
    ...
    <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionExample">
      <div class="card-body">
        <!-- Ventana Modal -->
        <button type="button"  class="btn bg-success text-white w-100 d-flex justify-content-center  mt-5 mb-5" data-toggle="modal" data-target="#exampleModal" data-whatever="@getbootstrap">AÑADIR COMPROMISOS</button>
                            ...
                            <form>
                                ...
                                <div class="row mb-5">
                                        ...
                                        <div class="col-6">
                                            ...
                                            <input class="form-control"   id="fecha-compromiso"  value="<?= date("d")."-".date("m")."-".date("Y");?>" readonly>
                                        </div>
                                </div>
